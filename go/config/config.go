...
type Configuration struct {
	...
	PostMasterFailoverProcessesFailureConsideredFailure bool              // Do we consider PostMasterFailoverProcesses failing as an orchestrator failure? Depends on policy and infrastructure integration
...
func newConfiguration() *Configuration {
	return &Configuration{
		...
		PostMasterFailoverProcessesFailureConsideredFailure: false,
